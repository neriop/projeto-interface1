  ...
  return (
    ...
    <html lang="pt">
      ...
      <body>
        ...
        <p id="description">Obrigado pela disponibilidade! Essa pesquisa nos ajudará a conhecer melhor os nossos clientes.</p>
        <div className="checkbox-container">
          <form id="survey-form">
            <fieldset>
              ...
              <div>
                <label id='recommend'>Você recomendaria nossa plataforma?</label>
